const places = [
  ...
  { name: "小牛田", reading: "こごた", prefecture: "宮城県" },
...
const decoys = {
  "長万部": ["ながまんぶ", "ちょうまんべ", "おさまんべ"],
  "倶知安": ["ぐちあん", "くちやす", "くちあん"],
  "占冠": ["うらかんむり", "しめかっぷ", "せんかん"],
  "弟子屈": ["でしくつ", "てしかく", "てしくつ"],
  "音威子府": ["おといこふ", "おんねっぷ", "おといしっぷ"],
  "留寿都": ["るじゅと", "りゅうすと", "るすと"],
  "比布": ["ひふ", "ひぬの", "ぴふ"],
  "興部": ["こうべ", "おきべ", "おこべ"],
  "神恵内": ["かみえない", "しんけいうち", "かもいうち"],
  "階上": ["かいじょう", "はしがみ", "きざはし"],
  "紫波": ["しなみ", "むらさきば", "しは"],
  "愛子": ["あいこ", "まなこ", "あやこ"],
  "小牛田": ["こうしだ", "おうしだ", "こぎゅうた"],
  "象潟": ["ぞうがた", "しょうかた", "きさがた"],
  "西馬音内": ["にしばおんない", "さいまねうち", "にしもうち"],
  "左沢": ["ひだりさわ", "さざわ", "あてらさわ"],
  "及位": ["きゅうい", "および", "のぞい"],
  "勿来": ["ぶつらい", "こない", "なき"],
  "会津坂下": ["あいづさかした", "あいづさかしも", "あいづばんか"],
  "潮来": ["しおらい", "ちょうらい", "いたく"],
  "行方": ["ゆくえ", "ぎょうほう", "なみかた"],
  "真岡": ["まおか", "しんおか", "もか"],
  "壬生": ["じんせい", "みずのえ", "にゅう"],
  ...
  "舎人": ["しゃじん", "やどり", "とねびと"],
  "福生": ["ふくお", "ふくせい", "ふっしょう"],
  "雑司が谷": ["ざっしがたに", "ぞうじがや", "ざつしがや"],
  "弘明寺": ["こうみょうじ", "ひろあきでら", "ぐみんじ"],
  "追浜": ["おいはま", "ついひん", "おっぱまえ"],
  "国府津": ["こくふつ", "こうふづ", "くにふつ"],
  "新発田": ["しんはった", "にいはつだ", "しんほった"],
  "石動": ["せきどう", "いしうごき", "いするき"],
  "羽咋": ["はねくい", "うさく", "はくわい"],
  "四方津": ["よもつ", "しほうづ", "よかたつ"],
  "小谷": ["こたに", "おだに", "こや"],
  "麻績": ["あさつむぎ", "まお", "おうみ"],
  "各務原": ["かくむはら", "かがみはら", "かかむがはら"],
  "函南": ["はこなん", "かんなん", "はんなみ"],
  "御器所": ["みきしょ", "ごきところ", "おきそ"],
  "放出": ["ほうしゅつ", "はなしで", "ほうで"],
  "交野": ["こうの", "かやの", "まじの"],
  "喜連瓜破": ["きれんうりは", "きつれうりやぶり", "きれうりは"],
  "先斗町": ["せんとまち", "さきとちょう", "ぽんとまち"],
  "御所": ["ごしょ", "みところ", "おんじょ"],
  "特牛": ["とくぎゅう", "こくご", "ことい"]
};
...
function buildChoices(question) {
  return shuffle([question.reading, ...decoys[question.name]]);
}
