...
// ===============================
const ASSETS = {
  good: asset("./assets/normal.png"), // 良品 松村
  bad: asset("./assets/defect.png"),  // 不良 松村
  bgm: asset("./assets/bgm.m4a"),     // BGM
};
...
// （レーンを光らせたくなったら使えるようにだけ取っておく）
// const laneLeft = document.querySelector(".lane-left");
// const laneRight = document.querySelector(".lane-right");
...
function spawnItem() {
  ...
  el.style.backgroundImage = `url("${isGood ? ASSETS.good : ASSETS.bad}")`;
